...
<body
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 20px; font-family: sans-serif;   color: #ebebeb; background-color:#5c2018; background-color:#5c2018;" role="presentation">
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="0"
                    style="background-color:#5c2018; padding: 10px 10px 10px 10px; text-align: center;"
                    role="presentation">
                    <tr>
                        <td>
                            Ваш новый пароль для входа в профиль:
                        </td>
                    </tr>
                    <tr>
                        <td>
